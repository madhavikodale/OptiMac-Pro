  ...
  return (
    <div className="min-h-full p-6 md:p-8 bg-neutral-950">
      ...
      <div className="mb-8">
        ...
        <p className="text-neutral-400">Customize OptiMac Pro to your preferences</p>
      </div>
      ...
      <div className="space-y-8">
                ...
                {setting.type === 'toggle' && (
                  <button
                    ...
                    className={`relative inline-flex h-8 w-14 items-center rounded-full transition-colors ${
                      setting.value ? 'bg-cyan-500' : 'bg-white/10'
                    }`}
                  >
                    <span
              ...
              >
                ...
                {setting.type === 'select' && (
                  <select
                    ...
                    className="px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white text-sm focus:border-cyan-400/50 transition-all"
                  >
                    {setting.id === '5' ? (
                      <>
        ...
        <div>
          ...
          <div className="glass rounded-xl p-6 border border-white/10 space-y-3">
            <div className="flex justify-between items-center pb-3 border-b border-white/10">
              <p className="text-white/60">App Version</p>
              <p className="text-white font-semibold">1.0.0</p>
            </div>
            <div className="flex justify-between items-center pb-3 border-b border-white/10">
              <p className="text-white/60">Build</p>
              <p className="text-white font-semibold">macOS 14.4+</p>
            </div>
            <div className="flex justify-between items-center">
              <p className="text-white/60">Copyright</p>
              <p className="text-white font-semibold">© 2025 OptiMac</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3 pt-4">
          <button className="w-full py-3 px-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg text-white font-semibold transition-all">
            Check for Updates
          </button>
